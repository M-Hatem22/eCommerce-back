...
namespace RestaurantApp.DAL.Migrations
{
    ...
    [Migration("20240119161055_dbUpdateimageAllowNull")]
    partial class dbUpdateimageAllowNull
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RestaurantApp.DAL.Data.Models.brand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantApp.DAL.Data.Models.category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("RestaurantApp.DAL.Data.Models.Item", b =>
                {
                    b.HasOne("RestaurantApp.DAL.Data.Models.brand", "brand")
                        .WithMany("items")
            ...
            modelBuilder.Entity("RestaurantApp.DAL.Data.Models.brand", b =>
                {
                    b.HasOne("RestaurantApp.DAL.Data.Models.category", "category")
                        .WithMany("brands")
